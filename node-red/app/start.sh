...
mkdir -p /data/node-red/user/flows || true
cp /usr/src/app/flows/* /data/node-red/user/flows/
# cp /usr/src/app/flows/* /data/node-red/user/lib/flows/
# cp /usr/src/app/flows/flows.json /data/node-red/user/flows.json
# cp /usr/src/app/flows/flows_cred.json /data/node-red/user/flows_cred.json
